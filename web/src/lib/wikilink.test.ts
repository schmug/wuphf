      ...
      children: [
        {
          ...
          children: [
            {
              type: "text",
              value: "See [[people/nazz]] and [[missing|Miss]] here.",
            },
          ],
        },
      ],
  ...
  it("leaves text untouched when no wikilinks are present", () => {
    ...
    const tree = {
      ...
      children: [
        {
          type: "paragraph",
          children: [{ type: "text", value: "Plain prose only." }],
        },
      ],
    };
    // Act
  ...
  it("ignores malformed wikilinks like [[..]] and [[a|b|c]]", () => {
    ...
    const tree = {
      ...
      children: [
        {
          type: "paragraph",
          children: [{ type: "text", value: "[[..]] and [[a|b|c]] are bad." }],
        },
      ],
    };
    // Act
