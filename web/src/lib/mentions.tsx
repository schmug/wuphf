 ...
 */
export function parseMentions(content: string, knownSlugs: readonly string[]): MentionToken[] {
  if (!content) return []
...
export function renderMentions(content: string, knownSlugs: readonly string[]): ReactNode[] {
